...
import { Paper, CircularProgress, Snackbar} from "@material-ui/core";
...
export default class LandingPage extends Component {
    ...
    authenticate = (options) => {
        return app.authenticate({ strategy: 'local', ...options })
            .then(() => this.setState({ isAuthenticated: true, redirect: true}))
    ...
    render() {
        ...
        const { redirect, isAuthenticated, isLoading, snackBarOpen, snackBarMessage } = this.state
