...
<html lang="en">
<head>
    <title>Code coverage report for express.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> express.ts
    </h1>
    <div class='clearfix'>
...
<span class="branch-0 cbranch-no" title="branch not covered" >          grant.response </span>: req.query;
&nbsp;
        const params = {
          authStrategies: [ name ],
